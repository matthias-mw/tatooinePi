...
class ADS1115():
    ...
    def __init__(self,bus,mux,scale):
        ...
        self.mux = mux
        self.scale = scale
        # Ãœbernahme der Mux Einstellung
    ...
    def __measure_analogIn(self):
        ...
        AnschlieÃŸend wird Config gepollt, um sicherzustellen, dass die Messung 
        abgeschlossen wurde. AnschlieÃŸend wird der Messwert ausgelesen und skaliert.
